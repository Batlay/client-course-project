...
const Test2 = () => {
    ...
    const getQuestions = async () => {
        const response = await axios.get(`${rootUrl}/api/tests/test2/`)
    ...
    const handleSubmit = e => {
        ...
        console.log(answers)
        axios.post(`${rootUrl}/api/tests/test2/answers/`, userInfo)
            .then(() => {
            window.close()
        });
    };
  ...
  return (
    ...
    <div> 
        ...
        { questions.map((q) => (
            ...
            <center>
                <MyButton style={{borderRadius: '5px'}} data-testid='save_button' type='submit' >
                    Сохранить
                </MyButton>
            </center>
        </form>
